...
export default function QRCodesPage() {
  ...
  const [origin, setOrigin] = useState<string>("http://localhost:7777");
    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 print:grid-cols-2 print:gap-8">
        {filteredTables.map((table) => {
          const targetUrl = `${origin}/order/${table.unique_code}`;
          return (
            <div
              key={table.id}
            ...
            >
              <div className="space-y-1 border-b border-divider pb-3">
                <p className="font-display font-bold text-[10px] uppercase tracking-widest text-brand-accent">
              ...
              <div className="h-48 w-48 mx-auto rounded-xl bg-white p-3 shadow-md border border-divider flex flex-col items-center justify-center space-y-2">
                <QRCodeCanvas value={targetUrl} size={160} />
